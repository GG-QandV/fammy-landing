...
export function AuthCTA() {
    ...
    if (isLoading) {
        return <div className="h-12 w-32 animate-pulse rounded-full bg-gray-200 mx-auto mt-4 mb-4"></div>;
    }
    ...
    return (
        <div className="hidden md:flex flex-col items-center justify-center gap-3 mt-4 mb-4 px-4 w-full">
            <Link
                href="/login"
